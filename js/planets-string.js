(function(){
    ...
    var listPlanetsStr = planetsArray.join('</li><li>')
    var newPlanetsArr = [listPlanetsStr];
    newPlanetsArr.push("</li></ul>");
    newPlanetsArr.unshift("<ul><li>")
    listPlanetsStr = newPlanetsArr.join('')
    console.log(listPlanetsStr);
